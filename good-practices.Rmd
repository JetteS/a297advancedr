...
```{r, include=FALSE}
WORDS_TO_IGNORE <- c("butitsuremakesthingseasiertoread", "addin", "Rproj", "Brun", "Julien", "CLI", "GPG", "MRE", "MREs", "Cheatsheets", "YOURGITHUBNAME", "rmarkdown")
...
```{r, echo=FALSE}
knitr::include_graphics("images/Remote_repository.png")
```
...
12. Your GitHub repository will now be cloned `r emo::ji("partying_face")`.
...
1. Go to [this](https://github.com/privefl/rmarkdown-website-template) GitHub repository created by Florian Privé. Fork the repository by opening the drop-down menu named <i class="fa-solid fa-code-fork"></i> `Fork` in the upper-right corner of the main page of the repository and selecting `+ Create a new fork`:
    ...
    ```{r, echo=FALSE}
    knitr::include_graphics("images/forkGitHubRepo.png")
    ```
